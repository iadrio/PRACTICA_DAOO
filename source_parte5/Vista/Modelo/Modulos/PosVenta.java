...
public class PosVenta
{
    ...
    /**
     * Marca una ficha de devolución como completada
     * @param numeroFicha numero de ficha de devolución
     */
    public void completarDevolucion(int numeroFicha){
        FichaDeDevolucion ficha=getFicha(numeroFicha);
        ficha.completar();
    }
    ...
    public void cancelarDevolucion(int numeroDeFicha)
    {
        ...
        {
            FichaDeDevolucion ficha =historialDevoluciones.get(numeroDeFicha);
            HashMap<String,Integer> listaProductos =ficha.getListaProductos();
