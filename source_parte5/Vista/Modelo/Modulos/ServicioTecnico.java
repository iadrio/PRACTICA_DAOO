 ...
 * @version  18.04.2018
 */
public class ServicioTecnico implements Observador,Serializable
{
    ...
    /**
     * Comunica a un cliente que su artículo ha sido reparado
     * @param ficha ficha de reparación que se ha completado
     */
    public void update(FichaReparacion ficha){
        ficha.comunicarCliente("Estimado cliente, su producto está listo para recogerse");
    }
    ...
    public int crearFicha(int numeroFichaDeCompra,String idCliente, String idProducto,String idEmpleadoActual)
    {
        ...
        fichaReparacion.addObserver(this);
        return numeroFicha;
    }
    ...
    /**
     * Finaliza una reparación
     * @param numeroFicha identificador único de la ficha de reparación
     */
    public void completarReparacion(int numeroFicha){
        FichaReparacion ficha = getFicha(numeroFicha);
        ficha.completar();
    }
