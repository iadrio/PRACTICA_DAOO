...
{
    private String codigoDeProducto,color,marca,modelo,tipoDeProducto,seccion,otrasCaracteristicas;
     ...
     * @param caracteristica caracteristica que se desea añadir
     */
    public void addCaracteristica(String caracteristica){
        int longitud=0;
        if(toString().lastIndexOf("\n")==(-1)){
            longitud=toString().length();
        }else{
            longitud=toString().substring(toString().lastIndexOf("\n")).length();
        }
        
        if(longitud>=150){
            otrasCaracteristicas=otrasCaracteristicas+"\n";  
        }
        otrasCaracteristicas=otrasCaracteristicas+", "+caracteristica;        
    }
    ...
    {
        return (formatea("cp: "+getCodigoDeProducto()+" Tipo:"+getTipo(),30)+formatea("marca:"+getMarca(),30)+formatea("modelo:"+getModelo(),30)+" "+
