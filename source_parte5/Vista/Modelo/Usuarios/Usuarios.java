...
public class  Usuarios
{
    ...
    public Usuarios(String ruta,SimpleDateFormat formatoFecha)
    {
        ...
        Cliente clienteDesconocido = new Cliente("desconocido","desconocido","desconocido","desconocido","desconocido","desconocido",formatoFecha);
        listaClientes.put("desconocido",clienteDesconocido);
    ...
    public Cliente getCliente(String id)
    {
            ...
            if(getExisteCliente(id)){
                ...
                return listaClientes.get("desconocido");
            }
    ...
    public boolean quitarPermiso(String identificacion,String permiso)
    {
        if(getExisteEmpleado(identificacion))
        {
            if(getPermisoValido(permiso))
            {
                getEmpleado(identificacion).setQuitarPermiso(diccionarioRoles.get(permiso));
                return true;
            }
            else
            {
