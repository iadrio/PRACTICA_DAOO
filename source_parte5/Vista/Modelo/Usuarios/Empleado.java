...
public class Empleado extends Persona
{
    ...
    public Empleado(String usuarioAdministrador,String claveAdministrador)
    {
     ...
     permisos.add(Roles.TECNICO);    
     permisos.add(Roles.CAJERO);    
     permisos.add(Roles.COMERCIAL);    
     permisos.add(Roles.POSTVENTA);    
     permisos.add(Roles.FINANCIERO);    
    }    
     ...
     */
    public void setQuitarPermiso(Roles permiso)
    {
